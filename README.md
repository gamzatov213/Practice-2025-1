...
**Figma:**
- [Ссылка на макет в Figma](https://www.figma.com/design/VzjYVkdsPGCCm9dWxyrnmO/Untitled?node-id=0-1&m=dev&t=1RyldhHnMM35Gm9f-1)  
- Проектирование пользовательского интерфейса  
- Создание прототипов и макетов  
- Совместная работа и визуализация структуры проекта  
- Подготовка дизайна под адаптивную вёрстку



## Вариативная часть задания (выполненно индивидуально)

**Разработка Telegram-бота AI-психолога на JavaScript с использованием OpenAI GPT-3.5**
